...
import numpy as np
from numpy._typing import NDArray  # type: ignore
from numpy._typing import _ArrayLikeAnyString_co as UST_co  # type: ignore
from numpy._typing import _ArrayLikeBytes_co as S_co  # type: ignore
from numpy._typing import _ArrayLikeInt_co as i_co  # type: ignore
from numpy._typing import _ArrayLikeStr_co as U_co  # type: ignore
from numpy._typing import _ArrayLikeString_co as T_co  # type: ignore
from numpy._typing import _Shape, _SupportsArray  # type: ignore
...
_StringDTypeOrUnicodeArray: TypeAlias = (
    np.ndarray[_Shape, np.dtype[np.str_]] | _StringDTypeArray
)
...
@overload
def find(
    a: U_co, sub: U_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.int_]: ...
@overload
def find(
    a: S_co, sub: S_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.int_]: ...
@overload
def find(
    a: T_co, sub: T_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.int_]: ...
@overload
def rfind(
    a: U_co, sub: U_co, start: i_co = ..., end: i_co | None = ...
...
@overload
def startswith(
    a: U_co, prefix: U_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.bool]: ...
@overload
def startswith(
    a: S_co, prefix: S_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.bool]: ...
@overload
def startswith(
    a: T_co, prefix: T_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.bool]: ...
@overload
def endswith(
    a: U_co, suffix: U_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.bool]: ...
@overload
def endswith(
    a: S_co, suffix: S_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.bool]: ...
@overload
def endswith(
    a: T_co, suffix: T_co, start: i_co = ..., end: i_co | None = ...
) -> NDArray[np.bool]: ...
def decode(
    a: S_co, encoding: str | None = ..., errors: str | None = ...
) -> NDArray[np.str_]: ...
def encode(
    a: U_co | T_co, encoding: str | None = ..., errors: str | None = ...
) -> NDArray[np.bytes_]: ...
@overload
...
@overload
def center(
    a: _StringDTypeSupportsArray, width: i_co, fillchar: UST_co = ...
) -> _StringDTypeArray: ...
@overload
def center(
    a: T_co, width: i_co, fillchar: UST_co = ...
...
@overload
def lstrip(
    a: _StringDTypeSupportsArray, chars: T_co | None = ...
) -> _StringDTypeArray: ...
@overload
...
@overload
def replace(a: U_co, old: U_co, new: U_co, count: i_co = ...) -> NDArray[np.str_]: ...
@overload
def replace(a: S_co, old: S_co, new: S_co, count: i_co = ...) -> NDArray[np.bytes_]: ...
@overload
def replace(
...
@overload
def replace(
    a: T_co, old: T_co, new: T_co, count: i_co = ...
) -> _StringDTypeOrUnicodeArray: ...
@overload
...
@overload
def translate(
    a: U_co, table: str, deletechars: str | None = ...
) -> NDArray[np.str_]: ...
@overload
def translate(
    a: S_co, table: str, deletechars: str | None = ...
) -> NDArray[np.bytes_]: ...
@overload
def translate(
    a: _StringDTypeSupportsArray, table: str, deletechars: str | None = ...
) -> _StringDTypeArray: ...
@overload
def translate(
    a: T_co, table: str, deletechars: str | None = ...
) -> _StringDTypeOrUnicodeArray: ...
