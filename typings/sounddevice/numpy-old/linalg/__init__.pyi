...
from typing import NamedTuple, SupportsIndex, SupportsInt, TypeAlias, TypeVar, overload
...
from numpy._typing import _ArrayLikeBool_co  # type: ignore
from numpy._typing import _ArrayLikeComplex_co  # type: ignore
from numpy._typing import _ArrayLikeFloat_co  # type: ignore
from numpy._typing import _ArrayLikeInt_co  # type: ignore
from numpy._typing import _ArrayLikeObject_co  # type: ignore
from numpy._typing import _ArrayLikeTD64_co  # type: ignore
from numpy._typing import _ArrayLikeUInt_co  # type: ignore
from numpy._typing import _ArrayLikeUnknown  # type: ignore
...
@overload
def tensorsolve(
    a: _ArrayLikeInt_co, b: _ArrayLikeInt_co, axes: None | Iterable[int] = ...
) -> NDArray[float64]: ...
@overload
def tensorsolve(
    a: _ArrayLikeFloat_co, b: _ArrayLikeFloat_co, axes: None | Iterable[int] = ...
) -> NDArray[floating[Any]]: ...
@overload
def tensorsolve(
    a: _ArrayLikeComplex_co, b: _ArrayLikeComplex_co, axes: None | Iterable[int] = ...
...
@overload
def tensorinv(
    a: _ArrayLikeComplex_co, ind: int = ...
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
...
def matrix_power(
    a: _ArrayLikeComplex_co | _ArrayLikeObject_co, n: SupportsIndex
) -> NDArray[Any]: ...
@overload
def cholesky(a: _ArrayLikeInt_co, /, *, upper: bool = ...) -> NDArray[float64]: ...
@overload
def cholesky(
    a: _ArrayLikeFloat_co, /, *, upper: bool = ...
) -> NDArray[floating[Any]]: ...
@overload
def cholesky(
    a: _ArrayLikeComplex_co, /, *, upper: bool = ...
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
...
@overload
def outer(
    x1: _ArrayLikeUInt_co, x2: _ArrayLikeUInt_co
) -> NDArray[unsignedinteger[Any]]: ...
@overload
def outer(
    x1: _ArrayLikeInt_co, x2: _ArrayLikeInt_co
) -> NDArray[signedinteger[Any]]: ...
@overload
def outer(x1: _ArrayLikeFloat_co, x2: _ArrayLikeFloat_co) -> NDArray[floating[Any]]: ...
@overload
def outer(
    x1: _ArrayLikeComplex_co, x2: _ArrayLikeComplex_co
) -> NDArray[complexfloating[Any, Any]]: ...
@overload
def outer(
    x1: _ArrayLikeTD64_co, x2: _ArrayLikeTD64_co, out: None = ...
) -> NDArray[timedelta64]: ...
@overload
...
@overload
def pinv(
    a: _ArrayLikeInt_co, rcond: _ArrayLikeFloat_co = ..., hermitian: bool = ...
) -> NDArray[float64]: ...
@overload
def pinv(
    a: _ArrayLikeFloat_co, rcond: _ArrayLikeFloat_co = ..., hermitian: bool = ...
) -> NDArray[floating[Any]]: ...
@overload
def pinv(
    a: _ArrayLikeComplex_co, rcond: _ArrayLikeFloat_co = ..., hermitian: bool = ...
) -> NDArray[complexfloating[Any, Any]]: ...
...
@overload
def matrix_norm(
    x: ArrayLike, /, *, ord: None | float | L["fro", "nuc"] = ..., keepdims: bool = ...
) -> floating[Any]: ...
@overload
def matrix_norm(
    x: ArrayLike, /, *, ord: None | float | L["fro", "nuc"] = ..., keepdims: bool = ...
...
@overload
def vector_norm(
    x: ArrayLike, /, *, axis: None = ..., ord: None | float = ..., keepdims: bool = ...
) -> floating[Any]: ...
@overload
def vector_norm(
    x: ArrayLike,
...
def diagonal(x: ArrayLike, /, *, offset: SupportsIndex = ...) -> NDArray[Any]: ...
def trace(
    x: ArrayLike, /, *, offset: SupportsIndex = ..., dtype: DTypeLike = ...
) -> Any: ...
@overload
def cross(
